...
<img src="/static/assets/learning/probml/ch0332-bootstrap-vs-bayes.png" width="70%">
...
- A standard solution is to re-wirte the model following a **non-centered parameterization**: $\theta_j=\mu+\tau\eta_j$, where $\eta\sim\mathcal{N}(0,1)$
    ...
    <img src="/static/assets/learning/probml/ch03622-non-centered-parameterization.png" width="75%">
