        ...
        <section className="hero-section">
          <div className="profile-section">
            ...
            <div className="social-links">
              ...
              <a href="https://www.linkedin.com/in/igodlab" className="social-link" target="_blank" title="LinkedIn">
                <svg className="social-icon" viewBox="0 0 24 24">
          ...
          <div className="bio-content">
            ...
            <div className="tagline"> Machine Learning • Blockchain Technology • Lifelong Learner</div>
            <p>
